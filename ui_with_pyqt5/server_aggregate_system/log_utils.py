...
#     logger.info('%s  %s', ntp_date+" "+ntp_time_ ,"Linewidth result is "+ lineWithResult)
...
def start_system_log():
    ...
    logger.info('%s  %s', ntp_date+" "+ntp_time_ ,"Start to use the server's aggregating system.      ")
